...
// [TASK] WRITE CODE FOR BLOCK TILLING HERE
    ...
    for (int i = 0; i < num_partitions; ++i) {
      ...
      args->row_start = i * part_size;
      args->row_end = (i < num_partitions - 1)? args->row_start + part_size : args->row_start + part_size + remainder;
      pthread_create( &threads[i], NULL, dot_block, (void *) args);
    }
    for (int i = 0; i < num_partitions; ++i) {
